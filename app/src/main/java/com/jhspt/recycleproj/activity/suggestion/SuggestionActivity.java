...
import com.jhspt.recycleproj.tool.Database;
...
public class SuggestionActivity extends AppCompatActivity {
    public static final String NoticeDBName = "Suggestion.db";
    public static final String NoticeTableName = "SuggestionInfo";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                    ...
                    startActivity(new Intent(getApplicationContext(), SuggestionSendActivity.class));
    ...
    private void showNoticeData(boolean forceUpdate) {
        ...
        if (Tools.isOnline(getApplicationContext())) {
            if (Tools.isWifi(getApplicationContext()) || forceUpdate) {
                ...
                mTask.execute("https://docs.google.com/spreadsheets/d/1KgjjZyTJ3cmeJXhfqemzo_RpwvTCX3enpfqTu1pNM0o/edit?usp=sharing");

                //https://docs.google.com/spreadsheets/d/1s-_F2vNNQ0yTBuqu_NORbeCJGBoaEHvsA4i84IBKWfA/pubhtml?gid=680150763&single=true
            } else {
    ...
    class getNoticeDownloadTask extends GoogleSheetTask {
        ...
        public void onPreDownload() {
            mDialog = new ProgressDialog(SuggestionActivity.this);
