...
public class NoticeSendActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boolean isAdmin = getIntent().getBooleanExtra("userAdmin_1", true);
        if (!isAdmin)
            finish();
    ...
    private class HttpTask extends AsyncTask<String, Void, Boolean> {
        ...
        protected Boolean doInBackground(String... params) {
            try {
                HttpPost postRequest = new HttpPost("https://script.google.com/macros/s/AKfycbyjLMyK1NIAbtxQ5XrzMad7IHJziXo4ul0lmIdemDp8Wr27DDDr/exec");
